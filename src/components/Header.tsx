    ...
    <header className="sticky top-0 z-50 bg-white/95 dark:bg-[#080c14]/90 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800/80 transition-all shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 w-full gap-4">
          ...
          <nav className="hidden xl:flex items-center space-x-6 text-xs xl:text-sm font-semibold text-slate-700 dark:text-slate-300 shrink-0">
            <a href="https://www.datacrumbs.org/" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
              Home
            </a>
            <a href="https://www.datacrumbs.org/ai-and-datascience" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
              AI Bootcamp
            </a>
            <a href="#booking-section" className="text-emerald-700 dark:text-emerald-400 flex items-center gap-1 font-bold bg-emerald-100 dark:bg-emerald-500/10 px-3 py-1 rounded-full border border-emerald-300 dark:border-emerald-500/30">
              <UserCheck className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
              1-on-1 Mentorship
            </a>
            <a href="https://www.datacrumbs.org/enterprise-solutions" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
              Enterprise
            </a>
            <a href="https://www.datacrumbs.org/hall-of-fame" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
              Hall of Fame
            </a>
            <a href="https://www.datacrumbs.org/about" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
              About Us
            </a>
          </nav>
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white dark:bg-[#0a0f1d] border-b border-slate-200 dark:border-slate-800 px-4 pt-4 pb-6 space-y-4 shadow-xl">
          <div className="flex items-center space-x-2 bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-700/80 px-3 py-1.5 rounded-full text-xs text-slate-800 dark:text-slate-300 w-fit font-medium">
            ...
            <span>Mentor Syed Abis Online Now</span>
          </div>
          <nav className="flex flex-col space-y-3 text-base font-semibold text-slate-800 dark:text-slate-300">
            <a href="https://www.datacrumbs.org/" className="hover:text-emerald-600 dark:hover:text-emerald-400 py-1">
              Home
            </a>
            <a href="https://www.datacrumbs.org/ai-and-datascience" className="hover:text-emerald-600 dark:hover:text-emerald-400 py-1">
              AI Bootcamp
            </a>
            <a onClick={scrollToBooking} className="text-emerald-700 dark:text-emerald-400 font-bold py-1 cursor-pointer">
              1-on-1 Mentorship Booking
            </a>
            <a href="https://www.datacrumbs.org/enterprise-solutions" className="hover:text-emerald-600 dark:hover:text-emerald-400 py-1">
              Enterprise
            </a>
            <a href="https://www.datacrumbs.org/hall-of-fame" className="hover:text-emerald-600 dark:hover:text-emerald-400 py-1">
              Hall of Fame
            </a>
          </nav>
          <button
