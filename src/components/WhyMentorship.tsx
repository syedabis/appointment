        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white dark:bg-slate-950/60 rounded-3xl p-8 border border-rose-200 dark:border-rose-500/20 relative space-y-6 shadow-sm hover:border-rose-400 hover:-translate-y-1 transition-all duration-300">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
              <span className="text-lg font-bold text-rose-600 dark:text-rose-400 flex items-center gap-2 tracking-tight">
                <XCircle className="w-5 h-5 text-rose-500" />
                Generic Pre-Recorded Tutorials
              </span>
              <span className="text-xs bg-rose-100 dark:bg-rose-500/10 text-rose-700 dark:text-rose-400 px-2.5 py-1 rounded font-semibold">
                Low Success
              </span>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900/90 rounded-3xl p-8 border-2 border-emerald-500/50 dark:border-emerald-500/50 relative space-y-6 shadow-xl shadow-emerald-500/10 hover:shadow-emerald-500/25 hover:-translate-y-1 transition-all duration-300">
            <div className="absolute top-0 right-0 bg-gradient-to-r from-emerald-500 to-cyan-500 text-slate-950 text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-bl-xl rounded-tr-2xl shadow-md">
              Recommended
            </div>

            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
              <span className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2 tracking-tight">
                <CheckCircle2 className="w-5 h-5 text-emerald-600 dark:text-emerald-400" />
                DataCrumbs 1-on-1 Mentorship
              </span>
              <span className="text-xs bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-400 px-2.5 py-1 rounded font-semibold">
                85% Placement
              </span>
            </div>
            ...
            <ul className="space-y-4 text-xs sm:text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-800 dark:text-slate-200 font-medium">
                  <strong className="text-slate-900 dark:text-white font-bold">Line-by-line code refactoring</strong> on your live GenAI & n8n repos
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                <span className="text-slate-800 dark:text-slate-200 font-medium">
                  <strong className="text-slate-900 dark:text-white font-bold">Production architectural advice</strong> for RAG, vector DBs, and FastAPI
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                <span className="text-slate-800 dark:text-slate-200 font-medium">
                  <strong className="text-slate-900 dark:text-white font-bold">Brutal ATS resume roast</strong> & LinkedIn optimization to land interviews
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                <span className="text-slate-800 dark:text-slate-200 font-medium">
                  <strong className="text-slate-900 dark:text-white font-bold">Realistic technical mock interviews</strong> with instant feedback
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                <span className="text-slate-800 dark:text-slate-200 font-medium">
                  <strong className="text-slate-900 dark:text-white font-bold">Direct intros & referrals</strong> to our 1,500+ tech company network
                </span>
              </li>
            </ul>
          </div>
